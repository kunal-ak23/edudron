...
# Deploy Identity Service to Azure Container Apps
# Usage: ./azure/scripts/deploy-identity.sh --config <config-file-path>
...
# Get service config
PORT=$(jq -r ".services.${SERVICE}.port" "$SERVICES_CONFIG" 2>/dev/null || echo "8081")
