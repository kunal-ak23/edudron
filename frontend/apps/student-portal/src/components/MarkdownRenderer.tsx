    ...
    <div className={`prose prose-sm max-w-none ${className}`}>
      <ReactMarkdown
        ...
        components={{
          ...
          h4: ({ node, ...props }) => <h4 className="text-lg font-medium mt-3 mb-2 text-white" {...props} />,
          ...
          p: ({ node, ...props }) => <p className="my-3 leading-relaxed text-gray-300" {...props} />,
          table: ({ node, ...props }) => (
          ...
          th: ({ node, ...props }) => (
            <th className="border border-gray-600 px-4 py-2 bg-gray-800 font-semibold text-left text-white" {...props} />
          ),
          td: ({ node, ...props }) => (
            <td className="border border-gray-600 px-4 py-2 text-gray-300" {...props} />
          ),
          hr: ({ node, ...props }) => <hr className="my-6 border-t border-gray-600" {...props} />,
        }}
      >
        {content}
      </ReactMarkdown>
