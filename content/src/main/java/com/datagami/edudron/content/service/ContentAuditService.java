...
import com.datagami.edudron.content.repo.AuditLogRepository;
...
@Service
public class ContentAuditService extends AuditService {

    private final AuditLogRepository auditLogRepository;

    @Autowired
    public ContentAuditService(AuditLogRepository auditLogRepository, ObjectMapper objectMapper) {
        super(objectMapper);
