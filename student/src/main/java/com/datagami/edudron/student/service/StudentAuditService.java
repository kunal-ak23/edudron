...
import com.datagami.edudron.student.repo.AuditLogRepository;
...
@Service
public class StudentAuditService extends AuditService {

    private final AuditLogRepository auditLogRepository;

    @Autowired
    public StudentAuditService(AuditLogRepository auditLogRepository, ObjectMapper objectMapper) {
        super(objectMapper);
